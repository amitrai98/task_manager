...
class DbHandler {
    ...
    public function createUser($name, $email, $password, $mobile_no) {
        ...
        if (!$this->isUserExists($email)) {
            ...
            // insert query
            $stmt = $this->conn->prepare("INSERT INTO users(name, email, password_hash, mobile_no, api_key, status) values(?, ?, ?, ?, ?, 1)");
            $stmt->bind_param("sssss", $name, $email, $password_hash, $mobile_no, $api_key);
